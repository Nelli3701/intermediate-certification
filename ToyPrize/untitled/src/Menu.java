...
public class Menu {
    ...
    public static void menu() {
        ...
        Toy toy1 = new RubberToy("Резиновый медвежонок", 8, 15);
        Toy toy2 = new RubberToy("Утёнок для купания", 5, 40);
        Toy toy3 = new PlasticToy("Кубики", 5, 60);
        Toy toy4 = new SoftToy("Единорог", 17, 50);
        Toy toy5 = new SoftToy("Микки Маус", 11, 30);
        Toy toy6 = new SoftToy("Кукла-принцесса", 4, 25);
        store.addToy(toy1);
        store.addToy(toy2);
        store.addToy(toy3);
        store.addToy(toy4);
